...
Leave it running; it picks up reviews as they come. Press **Ctrl-C** to stop. To keep it on across
reboots, install it as a background service — see the **service** notes included with the binary
